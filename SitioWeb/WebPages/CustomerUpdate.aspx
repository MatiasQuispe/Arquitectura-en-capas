<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerUpdate.aspx.cs" Inherits="SitioWeb.WebPages.CustomerUpdate" %>
    ...
    <form id="form1" runat="server">
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TxtContactTitle" runat="server" Width="200px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
